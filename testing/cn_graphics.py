...
def plot_list_limited(list, n=100, xlabel="", ylabel="", plot_im_name="plot.png"):
...
def plot_cn(noise_sample, n=100):
	...
	plot_list_limited(noise_sample, n, "Step", "Volume", "cn_plot.png")
...
def plot_cn_ps(ps_noise_sample, n=100):
	...
	plot_list_limited(ps_noise_sample, n, "Frequency", "Volume", "cn_ps_plot.png")
